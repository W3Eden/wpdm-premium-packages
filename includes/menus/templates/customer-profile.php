...
<div class="w3eden payout-entries">
    <?php
    $menus = [
        ['link' => "edit.php?post_type=wpdmpro&page=customers", "name" => __("All Customers", "wpdm-premium-packages"), "active" => false],
        ['link' => "#", "name" => __("Customer Profile", "wpdm-premium-packages"), "active" => true],
    ];
            ...
            <div class="modal-dialog modal-dialog-centered modal-sm" role="document">
                <div class="modal-content">
                    <div class="modal-header bg-light">
                        <h5 class="modal-title p-0 m-0"><?= __("Send Message", "wpdm-premium-packages"); ?></h5>
                    </div>
                    ...
                    <div class="modal-footer bg-light">
                        <a target="_blank" href="https://www.wpdownloadmanager.com/download/wordpress-private-message/" class="btn btn-success btn-block"><?php _e('Get Private Message Plugin', "wpdm-premium-packages") ?></a>
                    </div>
                </div>
            </div>

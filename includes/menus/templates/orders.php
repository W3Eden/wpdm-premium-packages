...
<div class="w3eden admin-orders">
    ...
    $menus = [
        ['link' => "edit.php?post_type=wpdmpro&page=orders", "name" => __("All Orders", "download-manager"), "active" => true],
        ['link' => "edit.php?post_type=wpdmpro&page=orders&task=createorder", "name" => __("Create New", "download-manager"), "active" => false],
    ];

    $actions = [
        [ "type" => "button",  "id" => "delete_selected",  "class" => "danger btn-sm", "name" => '<i class="sinc far fa-arrow-alt-circle-down"></i> ' . __("Delete Selected", "wpdm-premium-packages"), "attrs" => ["id" => "delete_selected"]],
    ];

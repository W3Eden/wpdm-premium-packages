...
//                );
            ...
            if (isset($wpdmpp_settings['auto_renew'], $wpdmpp_settings['order_validity_period']) && $wpdmpp_settings['auto_renew'] == 1 && $wpdmpp_settings['order_validity_period'] > 0){
                ...
                $paypalapi->createProduct($order_id, $order_title, $order_title, 'https://www.wpdownloadmanager.com/', 'https://cdn.wpdownloadmanager.com/wp-content/themes/wpdm5/images/wordpress-download-manager-logo.png')
                    ->createPlan($grand_total);
            }

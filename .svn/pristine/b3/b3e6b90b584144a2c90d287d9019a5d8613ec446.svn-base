...
As you already read, Premium Package has an "Automatic Order Expiration" option, probably you wondering where is "Automatic Order Renew". Good news is, Premium Package has this feature too. If you enable the auto-renew feature, on checkout the payment will be like a subscription/recurring payment and order will be renewed automatically at the end of each expiration period ( subscription-based pricing model ). Of course, you also can enable an order expiration and auto-renewal notification email for customers before you charge them.

            ...
            <form>
                ...
                <div class="input-group input-group-lg">
                    ...
                    <div class="input-group-addon">
                        <a href="edit.php?post_type=wpdmpro&page=customers"><?= esc_attr__( 'Clear Search', PM_TEXT_DOMAIN ) ?></a>
                    </div>
                    <?php } ?>
                    <input type="search" name="search" value="<?= wpdm_query_var('search') ?>" class="form-control" placeholder="<?= esc_attr__( 'ID / Name / Username / Email ...', PM_TEXT_DOMAIN ) ?>">
                    <div class="input-group-btn">
                        <button type="submit" class="btn btn-secondary"><?= esc_attr__( 'Search Customer', PM_TEXT_DOMAIN ) ?></button>
                    </div>
                </div>
            </form>
            <br/>

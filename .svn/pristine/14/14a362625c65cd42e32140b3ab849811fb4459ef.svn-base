    ...
    <div class="panel panel-default" id="wpdm-wrapper-panel">
        <div class="panel-heading">
            ...
            <div class="pull-right">
                <a href="#" id="apply" class="btn btn-sm btn-default" onclick="jQuery('#edit-license-form').submit();return false;"><i class="fa fa-floppy-o color-green"></i> <?php _e('Update License', 'wpdm-premium-packages'); ?></a>
            </div>
        </div>
                ...
                <div class="row">
                    <div class="col-md-8 col-md-offset-2">
                        <form method="post" action="" id="edit-license-form">
                            ...
                            <div class="form-group">
                                <button class="btn btn-primary"><i class="fa fa-floppy-o"></i> <?php _e('Update License', 'wpdm-premium-packages'); ?></button>
                            </div>

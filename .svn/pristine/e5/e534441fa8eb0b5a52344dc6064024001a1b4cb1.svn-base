...
<div id="checkout-login" class="panel panel-default">
    ...
    <div class="panel-body" style="<?php if ($current_user->ID) echo "display:none"; else echo ""; ?>" id="csl">
        <div class="row">
            <div class="col-md-6 signup-col" style="padding-right: 30px">
                <div id='wpdmreg_checkout'>
                    ...
                    <form method="post" action="" id="registerform" name="registerform" class="login-form">
                        ...
                        <input type="hidden" name="__phash" value="<?php echo \WPDM\libs\Crypt::Encrypt(array('captcha' => 'false', 'autologin' => 'true', )); ?>" />
                        ...
                        <?php global $wp_query; if(\WPDM\Session::get('reg_error')) {  ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group input-group-lg">
                                        ...
                                        <input class="form-control input-lg" required="required" type="email" size="25" placeholder="<?php _e('E-mail','wpdm-premium-packages'); ?>" id="user_email" value="<?php echo isset($tmp_reg_info['user_email'])?$tmp_reg_info['user_email']:''; ?>" name="wpdm_reg[user_email]">
                                    </div>
                ...
                <form name="loginform" id="loginform" action="" method="post" class="login-form" style="margin: 0">
                    ...
                    <div class="form-group">
                        <div class="input-group input-group-lg">
                            ...
                            <input placeholder="<?php _e('Email or Username','wpdm-premium-packages'); ?>" type="text" name="wpdm_login[log]" id="user_login" class="form-control input-lg required text" value="" size="20" tabindex="38" />
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="input-group input-group-lg">
                    ...
                    <div class="form-group">
                        <div class="well fetfont text-center text-muted">
                ...
                $(this).ajaxSubmit({
                    success: function (res) {
                        if (!res.success) {
                            ...
                            $('#wpdm-checkout').load(wpdm_ajax_url+"?action=payment_options", function () {
                                $.post(wpdm_ajax_url, {action: 'set_payment_method_for_order', method: $('#payment_form input.wpdm-payment-method:checked').val()}, function (res) {

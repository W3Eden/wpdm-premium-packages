...
?>
<div class="card card-default panel-purchases">
    <div class="card-header"><?php _e("Purchases", "wpdm-premium-packages"); ?></div>
    <table class="table" style="margin:0;">
        ...
        <tr>
            ...
            <th class="text-right"><?php _e("Payment Status", "wpdm-premium-packages"); ?></th>
        </tr>
        </thead>
        <?php
        ...
        foreach ($myorders as $order) {
            ...
            <tr class="order" id="order_<?php echo $order->order_id; ?>">
                ...
                <td><?php echo $date; ?></td>
                <td class="text-right"><?php echo $order->payment_status; ?></td>
            </tr>
            <?php
        }
        ?>

...
if( $order->uid == $current_user->ID ) {
    ...
    <div class="panel panel-default card-purchases dashboard-card mb-3">
...
SPEC;
    ...
    <div class="panel panel-default card-renew" style="margin: 10px 0 20px;padding: 15px" id="proceed_<?php echo $order->order_id; ?>">
         <div class="media">

...
<div class="card card-default dashboard-card">
    <div class="card-header">
        <a href="<?php the_permalink();echo $sap; ?>purchases/orders/" class="pull-right btn btn-sm btn-info"><?php _e('All Orders', 'wpdm-premium-packages'); ?></a><?php _e('Purchased Items', 'wpdm-premium-packages'); ?>
    </div>
    <table class="table">
        <thead>
            <tr>
        ...
        <tr>
            ...
            <td class="hidden-xs"><a class="ttip" title="<?php _e('View Order Details','wpdm-premium-packages'); ?>" href="<?php the_permalink(); echo $sap; ?>purchases/order/<?php echo $item->oid; ?>/"><?php echo $item->oid; ?></a></td>

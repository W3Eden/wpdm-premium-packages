...
<table width="100%" cellspacing="0" class="table">
    ...
    <tr>
        ...
        <td class="text-right"><strong><?php echo wpdmpp_price_format($order->total, true, true); ?></strong></td>
    </tr>
</table>
    ...
    <div class="w3eden admin-orders">
           ...
           <div class="row">
               <div class="col-lg-5">
                   <b><?php _e("Order Status:", "wpdm-premium-packages"); ?>
                       <select id="osv" name="order_status" class="form-control wpdm-custom-select" style="width: 150px;display: inline" >
               ...
               <div class="col-lg-5">
                   <b><?php _e("Payment Status:", "wpdm-premium-packages"); ?>
                       <select id="psv" class="wpdm-custom-select form-control" name="payment_status"  style="width: 150px;display: inline" >
               ...
               <div class="col-lg-2">
                   <button id="dlh" type="button" class="btn btn-info btn-block">Download History</button>
               </div>
           </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <span class="lead"><strong><?php echo $order->order_id; ?></strong> <?php echo $order->trans_id? "<span title='".sprintf(__("%s transaction ID", "wpdm-premium-packages"), $payment_method )."' style='font-size: 9pt' class='text-muted ttip'>( {$order->trans_id} )</span>":""; ?></span>
                </div>
            </div>
            </div>
            <div class="col-lg-3 col-md-6 col-sm-12">
            ...
            <div class="col-lg-3 col-md-6 col-sm-12">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <span class="lead color-green"><strong><?php echo wpdmpp_price_format($order->total, true, true); ?></strong></span> <i class="text-muted">via <?php echo str_ireplace("wpdm_", "", $order->payment_method); ?></i>
                    </div>
                </div>
            </div>

                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-4">
                            ...
                            <input type="text" size="16" class="form-control" id="base-price-field" name="file[base_price]"  value="<?php $base_price = (double)get_post_meta($post->ID,'__wpdm_base_price',true); if(isset($base_price)) echo number_format((double)$base_price,2,'.','');?>">
                        </div>
                        <div class="col-md-4">

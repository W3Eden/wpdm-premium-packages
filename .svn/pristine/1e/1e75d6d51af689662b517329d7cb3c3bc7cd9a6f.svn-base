            ...
            <form method="get" action="<?php echo admin_url('/edit.php'); ?>" id="orders-form">
                ...
                <span class="fa-stack">
                    ...
                    foreach($orders as $order) {
                        ...
                        $order_title = $order->title ? $order->title : $product_name[0];
                        ...
                        <i class="fa fa-<?php echo $osi[$order->order_status]; ?> fa-stack-1x"></i>
                            ...
                            <td class="">
                                ...
                                <small class="text-muted">
                                    ...
                                    <?php if($order->trans_id !== '') { ?><span class="ttip" title="<?php echo __( "Transaction ID", "download-manager" ) ?>"><i class="fas fa-bullseye" style="color: var(--color-primary);margin-left: 5px"></i> <?php echo $order->trans_id; ?></span><?php } ?>
                                </small>
                            </td>
                            <td class="">
                                <div class="w3eden">

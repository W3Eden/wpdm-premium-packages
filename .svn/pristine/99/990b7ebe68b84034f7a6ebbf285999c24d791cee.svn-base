    ...
    <div class="panel panel-default">
        ...
        <table class="table table-striped">
            ...
            <tr>
                ...
                <td><input  class="form-control input-sm" style="width: 80px" type="number" size="8" name="comission[default]" value="<?php echo isset($comission['guest']) ? $comission['guest'] : ''; ?>"></td>
            </tr>
            <?php
            global $wp_roles;
            ...
            foreach( $roles as $role => $name ) {
                ...
                <tr>
                    ...
                    <td><input type="number" class="form-control input-sm" style="width: 80px" size="8" name="comission[<?php echo $role; ?>]" value="<?php echo (double)$comission[$role]; ?>"></td>
                </tr>
            <?php } ?>
            <tr>

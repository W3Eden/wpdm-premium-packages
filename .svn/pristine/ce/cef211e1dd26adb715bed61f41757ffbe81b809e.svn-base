    ...
    if(isset($order_notes['messages'])){
        foreach ($order_notes['messages'] as $time => $order_note) {
            ...
            <div class="panel panel-default dashboard-panel">
                ...
                <?php } ?>
                <div class="panel-footer text-right">
                    <small><em><i class="fas fa-pencil-alt"></i><?php echo $order_note['by']; ?>&nbsp;<i class="fa fa-clock-o"></i><?php echo date(get_option('date_format') . " h:i", $time); ?></em></small>
...
<form method="post" id="post-order-note">
    ...
    <div class="panel panel-default dashboard-panel">
        <textarea required id="order-note" name="note" class="form-control" style="border: 0;box-shadow: none;min-height: 90px;max-width: 100%;min-width: 100%;padding: 10px"></textarea>
        ...
        <div class="panel-footer">
            <div class="row">
                <div class="col-md-6 col-xs-12 text-left">
                    <label><?php _e('Send to:','wpdm-premium-packages'); ?></label>&nbsp;
